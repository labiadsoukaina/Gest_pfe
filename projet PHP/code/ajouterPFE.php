...
//espace etudient2
$nouveauEtudiant = $dom->createElement("Etudiant2");
$nouveauPROJET->appendChild($nouveauEtudiant);

$nouveauNOM = $dom->createElement("Nom2");
$nom = $dom->createTextNode($nom2);// modifier 

$nouveauEtudiant->appendChild($nouveauNOM);
$nouveauNOM->appendChild($nom);

$nouveauPRENOM = $dom->createElement("Prénom2");
$prenom = $dom->createTextNode($pren2);//  modifier 

$nouveauEtudiant->appendChild($nouveauPRENOM);
$nouveauPRENOM->appendChild($prenom);

$nouveauMail = $dom->createElement("Mail2");
$mail = $dom->createTextNode($mail2);// a modifier

$nouveauEtudiant->appendChild($nouveauMail);
$nouveauMail->appendChild($mail);

$nouveauTelephone = $dom->createElement("tel2");
$tele = $dom->createTextNode($tel2);// a modifier 

$nouveauEtudiant->appendChild($nouveauTelephone);
$nouveauTelephone->appendChild($tele);

$nouveauOption = $dom->createElement("Option2");
$option = $dom->createTextNode($Option2);// a modifier 
